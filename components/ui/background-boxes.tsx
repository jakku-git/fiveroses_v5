  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        <div className="h-full w-full flex items-center justify-center px-4 md:px-0 -mt-16 md:mt-0">
          <MorphingText
            texts={[
              "BUILD",
              "CRAFT",
            ...
            className="text-[clamp(3rem,15vw,6rem)] md:text-[clamp(5rem,25vw,25rem)] font-medium text-white text-center tracking-tighter max-w-[90vw] md:max-w-none"
          />
        </div>
      </div>
    </div>

...
export default function Home() {
    ...
    return (
        <>
            {/* 1. Hero Section - Mobile-optimized with conditional rendering */}
            {isMobile ? (
                <MobileHero />
            ) : (
            ...
            <main className={`${styles.main} transform-gpu will-change-transform`}>
                {/* 7. Parallax Gallery Section - Desktop only, mobile gets simplified version */}
                {!isMobile && <ParallaxGallery />}

                {/* 2. Zoom Parallax Section - Desktop only */}
                ...
                {/* 3. Perspective Section - Conditional rendering for mobile */}
                {isMobile ? (
                    <div className="w-full py-12 px-4 bg-black">
                        ...
                        >
                            <div className="relative h-[60vh] rounded-2xl overflow-hidden">
                                <img 
                                    src="https://pub-172cf25c478a4ad6ab218ee60b1a4b4f.r2.dev/home%20(3).webp"
                            ...
                            <div className="relative h-[60vh] rounded-2xl overflow-hidden">
                                <img 
                                    src="https://pub-172cf25c478a4ad6ab218ee60b1a4b4f.r2.dev/home%20(2).webp"
                                    alt="Let's create something"
                                    className="w-full h-full object-cover"
                                />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col items-start justify-end p-6 gap-4">
                                    <h2 className="text-3xl font-light tracking-tighter text-white">
                                        Let's create something.
                                    </h2>
                                    <a 
                                        href="/contact"
                                        className="px-6 py-3 bg-white text-black font-medium rounded-full hover:bg-white/90 active:bg-white/80 transition-colors touch-manipulation"
                                    >
                                        Let's Talk.
                                    </a>
                                </div>
                ...
                {/* 4. Gallery Section - Mobile-optimized layout */}
                ...
                {/* 8. Original Projects Section - Mobile-optimized */}
                <section className={styles.originalSection}>
                    <h1 className="text-2xl md:text-3xl lg:text-5xl font-light tracking-tighter mb-6 md:mb-8 px-4">Partnerships</h1>

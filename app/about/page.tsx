      ...
      <div className="w-full bg-black text-white">
        <div className="w-[80%] mx-auto pt-24">
          ...
          <div className="space-y-6 max-w-3xl mb-16">
            ...
            fiveroses is not just a creative studio.
            We’re a collective of makers, thinkers, and storytellers bridging imagination and execution. We exist to craft meaningful experiences that don't just look beautiful, but feel unforgettable.
            </p>
            <p className="text-xl font-light text-white/70 leading-relaxed">
